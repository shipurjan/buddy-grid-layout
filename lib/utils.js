...
export function moveElement(
  ...
  if (
    l.y !== y &&
    collides(l, { ...l, i: "\0", x: x ?? l.x, y: y ?? l.y, h: 1 })
  )
    return layout;
...
export function moveElementAwayFromCollision(
  ...
  const itemAtBeginningOfNextRow =
    isUserAction &&
    itemToMove.x === 0 &&
    collidesWith.w >= itemToMove.w &&
    oldPos.y < collidesWith.y;

  const deltaShiftX = isLeftShift
    ? -collidesWith.w
    : itemAtBeginningOfNextRow
      ? -collidesWith.w
      : 1;
